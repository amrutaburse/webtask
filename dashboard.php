...
<div class="container">
  <div class="header">
    <div class="header-logo">
      ...
      <span class="site-title">Banking</span> 
    </div>
  ...
  <div class="main">
    <div class="sidebar">
      <ul>
        <li><a href="dashboardconnect.php" class="active"><i class="lni lni-home"></i><span>User Account Form</span></a></li>
        <li><a href="registerview.php"><i class="lni lni-text-format"></i><span>Register</span></a></li>
        <li><a href="dashboardloanconnect.php"><i class="lni lni-bar-chart"></i><span>Loan</span></a></li>
        <li><a href="feedbackview.php"><i class="lni lni-grid"></i><span>Feedback</span></a></li>

        <li><a href="loancalculator.php"><i class="lni lni-bullhorn"></i><span>Loan Calculator</span></a></li>
        <li><a href="login.php"><i class="lni lni-support"></i><span>Logout</span></a></li>
      </ul>
    </div>

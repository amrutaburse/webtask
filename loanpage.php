        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="loanpageconnect.php" method="POST">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="permanantaddress" class="form-control" name="permanent-address">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="monthlyincome" class="form-control" name="monthlyincome">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="loantype" class="form-control" name="loantype">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Loan Reason</label>
                                    <div class="col-md-6">
                                        <input type="text" id="loanreason" class="form-control" name="loanreason">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Loan Ammount</label>
                                    <div class="col-md-6">
                                        <input type="text" id="loanammount" class="form-control" name="loanammount">
                                    </div>
                                </div>

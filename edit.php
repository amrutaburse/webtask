...
<html>
 ...
 <br />
  ...
  <div class="container box">
   <br />
   <h2 align="center">Update Data</h2><br />
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
        <div class="form-group">
         ...
         <input type="text" name="first_name" id="first_name" value="<?php echo $firstname;?>" class="form-control" />
         <span id="error_first_name" class="text-danger"></span>
        </div>
        <div class="form-group">
         <label>Enter Last Name</label>
         <input type="text" name="last_name" id="last_name" value="<?php echo $lastname;?>" class="form-control" />
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
        ...
        <div class="form-group">
         ...
         <input type="text" name="mobile_no" id="mobile_no" value="<?php echo $mobileno;?>" class="form-control" />
        ...
        <div align="center">
         ...
         <button type="button" name="btn_contact_details" id="btn_contact_details" class="btn btn-success btn-lg">Update</buttton>
